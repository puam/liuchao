...
function logIn() {
    ...
    if ((name === null || name === "" || name === undefined)|| ( pwd === null || pwd === undefined || pwd === "")){
        ...
        //url,后台地址加，登陆请求地址。
        //content-type头的信息，模拟h//         xhr.setRequestHeader("content-type","application/x-www-form-urlencoded,charset=uff-8");//使用send方法传送参数的时候，需要设定ttp post方法发送一个表单。这样服务器才知道我们要发送的什么？
